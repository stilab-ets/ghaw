...
description: Generates weekly review retrospective articles and renders HTML in all 14 supported languages in a single agentic run (EN + SV + 12 translated). Runs Saturdays to review the past week.
strict: false
imports:
...
- **Rendered HTML**: `news/$ARTICLE_DATE-weekly-review-{en,sv,da,no,fi,de,fr,es,nl,ar,he,ja,ko,zh}.html` — **always all 14 languages** (produced by `scripts/render-articles.ts`)
