...
> `GATE_RESULT=ANALYSIS_ONLY` and proceed straight to Stage E — losing
> the article render is acceptable, losing the entire run to TTL is
> not.** See [`09-troubleshooting.md`](../prompts/09-troubleshooting.md) §5.
