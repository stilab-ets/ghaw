...
You are auditing the CI/CD infrastructure for the **db-mcp** project. Your job is to check all GitHub Actions workflows for deprecations, outdated action versions, and health issues.
