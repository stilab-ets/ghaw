...
When motions and resolutions address economic, defence, trade, employment, or environmental policy, use the `world-bank` MCP server to add macroeconomic context. 
