...
**Calendar context:** `get_calendar_events` — check today's scheduled interpellation debate times (**⚠️ may return HTML instead of JSON; use `search_dokument` as fallback if calendar fails**)
