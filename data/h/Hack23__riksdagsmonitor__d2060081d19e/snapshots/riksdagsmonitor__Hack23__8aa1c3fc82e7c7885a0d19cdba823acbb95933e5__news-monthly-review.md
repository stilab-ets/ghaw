...
description: Generates monthly review retrospective articles and renders HTML in all 14 supported languages in a single agentic run via executive-brief cascade. Runs on 28th of each month.
strict: false
imports:
