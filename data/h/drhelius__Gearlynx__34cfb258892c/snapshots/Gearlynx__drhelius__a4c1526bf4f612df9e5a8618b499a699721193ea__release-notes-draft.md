...
Detect the newest Gearlynx draft release created by the `Build and Release` workflow and replace its generated release notes with concise notes that match the recent manual release style.
...
4. Common phrases include `Improved accuracy`, `Improved MCP server`, `Improved debugger`, `Updated Game Controller DB`, and `Many bug fixes and improvements`.
...
**Full Changelog**: https://github.com/drhelius/Gearlynx/compare/<previous>...<current>
```
