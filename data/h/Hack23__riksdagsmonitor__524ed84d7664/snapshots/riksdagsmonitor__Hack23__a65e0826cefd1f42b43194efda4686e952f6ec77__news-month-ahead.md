...
description: Generates month-ahead strategic outlook articles and renders HTML in all 14 supported languages in a single agentic run (EN + SV + 12 translated). Runs on 1st of each month.
strict: false
imports:
